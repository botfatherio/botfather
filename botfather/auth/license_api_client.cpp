...
void LicenseApiClient::requestLicense(const QString &software,
...
bool LicenseApiClient::isLicenseActive() const { return m_premend > m_curtime; }
...
void LicenseApiClient::processJsonResponse(QJsonDocument json) {
    ...
    if (!json.object().contains("curtime") ||
        !json.object().contains("premend")) {
