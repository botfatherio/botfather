...
void RestApiClient::adjustSslConfiguration(QSslConfiguration &ssl_config)
{
        ...
        // Only use certs we trust during the ssl handshake. This includes our
own api fullchain cert
        // and lets encrypts self signed certs.
...
QString RestApiClient::certificateChecksum(QCryptographicHash::Algorithm
algorithm)
{
        QMap<QCryptographicHash::Algorithm, QString> checksums = {
                { QCryptographicHash::Algorithm::Md5,
"b37704ddfe0e5f63746898cb24a8872a" }, { QCryptographicHash::Algorithm::Sha1,
"f91ec934af9972eea03b88cb778950354968d037" }, {
QCryptographicHash::Algorithm::Sha224,
"23c1be1c9cb20bdab713acd5231ea2fc76d7cbfab6e2b585eaa1d08a" }, {
QCryptographicHash::Algorithm::Sha256,
"fc2d7cc1f4d53578497915897bd1a481c6ef7f3c4925c7fbe1fc07c71ad7f973" }, {
QCryptographicHash::Algorithm::Sha384,
"4ff13cbe165e8af0dc62e377818d128033cb8c11e4273c81562604e2ca509647d1db07a188a97111123b8bf2d3b9d925"
}, { QCryptographicHash::Algorithm::Sha512,
"2d071509b7a6c53b327699dd4c97f0bc53ae3ae39d7c1858e9e3f312a99a6e46d4795a948eafe241668e7b640ce3d47e77bd532ed6a70ec89cd2e7a8dab4ba7f"
}
        };
...
{
        QByteArray pem_cert =
reply->sslConfiguration().peerCertificate().toPem();
        ...
        for (const QCryptographicHash::Algorithm &algorithm : algorithms)
        {
                ...
                QString hash = QCryptographicHash::hash(pem_cert,
algorithm).toHex(); if (hash != checksum)
                {
                        qDebug() << "Cert checksum missmatch:" << hash <<
