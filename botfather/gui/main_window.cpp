...
void MainWindow::showAboutDialog() {
    QString text =
        QString(
            "<html><body>"
            "<p><b>Botfather</b> is a cross-platform automation and bot "
            "framework for Android, Browser, and Desktop applications"
            "more.</p>"
            ...
            "%1</p>"
            "<b>Used by Botfather:</b>"
            "<p>Those beautiful icons are by Icons8.<br>"
