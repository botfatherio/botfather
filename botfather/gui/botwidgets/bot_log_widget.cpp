...
void BotLogWidget::log(const QString &message, const Engine::LogSource &source)
{
	QString time(QDateTime::currentDateTime().toString("HH:mm:ss"));
	QString color, source_name;

	if (source == Engine::LogSource::Debug && !m_bot_settings->value("debug_mode").toBool())
	{
