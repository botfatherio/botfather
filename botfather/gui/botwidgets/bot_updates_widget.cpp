...
BotUpdatesWidget::BotUpdatesWidget(Bot *bot, QWidget *parent)
    : QWidget(parent), ui(new Ui::BotUpdatesWidget), m_bot(bot) {
    ui->setupUi(this);
    ...
    connect(ui->check_button, &QPushButton::clicked, this,
            &BotUpdatesWidget::checkForUpdates);
    connect(ui->update_button, &QPushButton::clicked, this,
            &BotUpdatesWidget::updateTheBot);

    connect(bot, &Bot::statusChanged, this,
            &BotUpdatesWidget::botStatusChanged);
    connect(bot, &Bot::statusCheckFailed, this,
...
BotUpdatesWidget::~BotUpdatesWidget() { delete ui; }
...
void BotUpdatesWidget::updateTheBot() {
    ...
    connect(git_progress_dialog, &GitProgressDialog::accepted, this,
            &BotUpdatesWidget::checkForUpdates);
    connect(git_progress_dialog, &GitProgressDialog::rejected, this,
            &BotUpdatesWidget::resetProgressIndicators);
...
void BotUpdatesWidget::botStatusChanged(const Bot::Status &status) {
    ...
    QString time_string =
        QDateTime::currentDateTime().toString("ddd MMM, hh:mm:ss");
