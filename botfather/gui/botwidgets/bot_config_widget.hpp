...
class BotConfigWidget : public QWidget {
   ...
   public:
    ...
    void renderBooleanOption(BotConfigOption *option_p,
                             QFormLayout *form_layout);
    void renderNumberOption(BotConfigOption *option_p,
                            QFormLayout *form_layout);
    void renderIntegerOption(BotConfigOption *option_p,
                             QFormLayout *form_layout);
    void renderStringOption(BotConfigOption *option_p,
                            QFormLayout *form_layout);
    void renderPasswordOption(BotConfigOption *option_p,
                              QFormLayout *form_layout);
    void renderChoiceOption(BotConfigOption *option_p,
                            QFormLayout *form_layout);
