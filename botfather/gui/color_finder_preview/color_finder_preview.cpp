...
ColorFinderPreview::ColorFinderPreview(const QString &file_name, QWidget *parent)
    : QWidget(parent)
{
...
void ColorFinderPreview::updateColors(int min_h, int min_s, int min_v, int max_h, int max_s, int max_v)
{
