...
class RectPrototype : public AbstractPrototype {
   ...
   public:
    ...
    // changed, but not the left one. https://doc.qt.io/qt-5/qrect.html#setWidth
    ...
    // changed, but not the top one. https://doc.qt.io/qt-5/qrect.html#setHeight
    ...
    // edge). https://doc.qt.io/qt-5/qrect.html#contains
    ...
    Q_INVOKABLE bool contains(const QRect &other_rect,
                              bool proper = false) const;

    // Returns true if this rectangle intersects with the given rectangle,
    // otherwise returns false. https://doc.qt.io/qt-5/qrect.html#intersects
