...
namespace Vision {
cv::Mat isolateColor(const cv::Mat &image, const cv::Scalar &min_hsv,
...
QVector<Match> findMaskedMatches(const cv::Mat &image, const cv::Mat &tpl,
                                 const cv::Mat &mask, double threshold,
                                 int max_matches);
Match findMaskedMatch(const cv::Mat &image, const cv::Mat &tpl,
                      const cv::Mat &mask, double threshold);

QVector<Match> findMatches(const cv::Mat &image, const cv::Mat &tpl,
                           double threshold, int max_matches = 7);
...
QVector<Match> findBlobs(const cv::Mat &image,
                         const cv::SimpleBlobDetector::Params &blob_params);

QImage markMatches(const QImage &image, const QVector<Match> &matches,
