...
{
Qt::KeyboardModifier mapBFKeycodeToQtKeyboardModifier(const QString &bf_keycode);
...
int mapQtKeyboardModifiersToCefKeyModifiers(const Qt::KeyboardModifiers &qt_keyboard_modifiers);
}
