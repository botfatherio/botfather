...
class PointPrototype : public AbstractPrototype {
   ...
   public:
    ...
    // Returns a QPoint object that is the sum of this point and other_point;
    ...
    // Returns a QPoint object that is formed by subtracting other_point from
    // this point; each component is subtracted separately.
