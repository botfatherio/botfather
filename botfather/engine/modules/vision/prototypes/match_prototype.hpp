...
class MatchPrototype : public AbstractPrototype {
   ...
   public:
    ...
    // Returns the matches score. The score describes how good the match matches
    // what has been searched for. A score of 0.0 means the match matches the
    // subject 0%. 0.42 means the match matches 42% and 1.0 means the match
    // matches 100%.
