...
public:
	...
	void OnLoadError(CefRefPtr<CefBrowser> browser, CefRefPtr<CefFrame> frame, ErrorCode error_code, const CefString &error_rext, const CefString &failed_url) override;
