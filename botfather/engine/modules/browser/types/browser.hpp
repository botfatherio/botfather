...
public:
	...
	bool evaluateJavascript(const QString &script_name, const QString &javascript_code, int timeout_in_ms, QCborValue &result, QVariantMap &exception, bool &timed_out);
