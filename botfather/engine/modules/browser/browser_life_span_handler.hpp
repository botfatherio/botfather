...
public:
	...
	// When a website closes itself, its underlying CefBrowser usually would get destroyed.
	// Unless we explicitly allowed to browser to close itself we prevent it.
